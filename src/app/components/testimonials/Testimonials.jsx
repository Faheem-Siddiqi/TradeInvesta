            ...
            <section className="md:my-10">
                ...
                >
                    {testimonials.map((testimonial, index) => (
                        <SwiperSlide key={index} className="relative  p-5 sm:!h-[29rem] sm:!w-[25rem] text-white !border-white  !border-2  body-gradient  border-white/10 rounded-[0.7rem] overflow-hidden ">
