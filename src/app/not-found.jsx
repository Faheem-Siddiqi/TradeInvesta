                    ...
                    <div className="container flex flex-col md:flex-row items-center justify-center px-5 text-green-00">
                        <div className="max-w-md">
                            ...
                            <button
                                ...
                                className="px-7 font-Poppins-Regular py-3 rounded-md group relative overflow-hidden  bg-DarkBlue  text-white transition-all duration-300 ease-out hover:bg-gradient-to-r hover:from-bg-Green475 hover:to-bg-Green475 ">
